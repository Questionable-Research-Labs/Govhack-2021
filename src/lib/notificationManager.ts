	...
	if (notificationsSupported()) {
		...
		if (Notification.permission === 'denied') {
			notificationErrorText =
				'Notifications have been blocked, check site permissions<br><a target=”_blank” rel=”noopener noreferrer” href="https://support.google.com/chrome/answer/3220216?hl=en&co=GENIE.Platform%3DDesktop">Chrome Guide</a>';
		}
